    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                sprintf('<input class="form-control" type="text" placeholder="%s">', this.options.formatSearch()),
                '</div>',
            );
                ...
                if (that.options.columns[j].checkbox || that.options.columns[j].radio) {
                    ...
                    text = [
                        ...
                        '<input' +
                            ...
                            sprintf(
                                ' disabled="%s"',
                                !that.options.columns[j].checkboxEnabled || (value && value.disabled)
                                    ? 'disabled'
                                    : undefined,
                            ) +
                            ' />',
                    ...
                    text = that.options.cardView
                        ...
                        : [sprintf('<td%s %s %s>', id_, class_, style), value, '</td>'].join('');
                }
